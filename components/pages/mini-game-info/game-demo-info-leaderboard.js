import image from "assets/img/mini-game/img-leaderboard.png"
import AvarikButton from "components/avarik-saga/avarik-button"
import { useScrollAnim } from "components/hooks/hooks"

const MiniGameInfoLeaderboard = () => {
    const [trigger, anim] = useScrollAnim()
    return (
        <section className="sc-mini-game-info-leaderboard" ref={trigger}>
...
export default MiniGameInfoLeaderboard