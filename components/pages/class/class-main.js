...
import ModalRarityClass from "components/avarik-saga/modal-rarity/modal-class"
        ...
        <div className="container">
          <div className="row justify-content-between">
            <div className="col-lg-5 col-text">
              ...
              <p className={anim(2)}>
                From chivalrous knights to notorious wizards and cunning
                marksmen, these 3 classes in the Avarik Kingdom have to work
                hand-in-hand to achieve glory.
              </p>
              <br />
              <AvarikButton
            ...
            <div className="col-lg-7 col-img">
              {data.map((item, i) => (
                <img
                  ...
                  className={`img-fluid img-char ${anim(
                    i + 3,
                    "revealInDown"
                  )}`}
                />
