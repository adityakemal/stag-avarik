            ...
            <section className="py-main h-100 content-center sc-notfound" ref={trigger}>
                <div className="container d-flex flex-column align-items-center">
                    ...
                    <div className="col-md-6 text-center py-4 d-flex flex-column align-items-center">
                        <h4 className={`text-white ${anim(11)}`}>Looks like you’ve got lost..</h4>
                        <p className={`text-gray-500 font-weight-light text-center w-300px ${anim(12)}`}>The page you’re looking for doesn’t exist or has been moved</p>
